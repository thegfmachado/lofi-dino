  ...
  return (
    ...
    >
      <div className="flex flex-col h-full w-full items-center bg-slate-900">
        ...
        <section className="flex justify-center gap-6 mt-[9rem] w-5/6 h-[45rem] border z-10">
          <iframe
        ...
        <footer className="h-full pt-20 pb-5 flex flex-col gap-4 justify-center items-center sm:text-base lg:text-lg mt-10">
          ...
          <a className="btn btn-outline btn-primary text-base md:text-lg" href="https://github.com/thegfmachado" target="_blank" rel="noreferrer">
            {`<gfm />`}
          </a>
